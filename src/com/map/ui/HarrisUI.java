...
public class HarrisUI {
	...
	public HarrisUI() {	
		...
		JLabel jLabel = new JLabel("角点检测参数:");
        JTextField jTextField = new JTextField(10);
        JLabel jLabel3 = new JLabel("角点检测邻域值:");
		...
		JButton btn = new JButton("角点提取影像1");
		btn.setBounds(300, 10, 100, 20);//按钮的位置大小
		JButton btn1 = new JButton("角点提取影像2");
		btn1.setBounds(420, 10, 100, 20);//按钮的位置大小
		JButton OK = new JButton("角点提取");
		...
		OK.addActionListener(new ActionListener() {		
			@Override
			public void actionPerformed(ActionEvent e) {
				initUI.label.setIcon(new PictureShow(new ImageIcon("D:\\images\\harrisResult.JPG")));
